...
contents. It will then calculate the average of the numbers.\n')
    #get file name of file containing the values to be calculated
    file = 'numbers.txt'
...
def errorHandleTest():
    #IOError handling test
    print('Error handling test.')
    try:
        #get the name of the file
        file = input('Enter an invalid filename or a file with non-number values: ')
